...
#
# # 生成1000个不重复的随机索引
# indices = np.random.randint(0, len(train_X), size=7000)
# train_X = train_X[indices]
# train_Y_d = train_Y_d[indices]
# train_Y_i = train_Y_i[indices]
# dict = {"outputdim": 16, "lr": 1e-4, "batch_size": 64, "epoch": 200, "saveflag": False}
#
...
# # 创建数据
x = [1, 2, 3, 5, 7, 10, 20, 30, 40, 50, 60, 70, 100]  # K
y = [37.644, 46.244, 50.125, 58.438, 69.981, 79.787, 85.644, 89.99, 91.562, 94.25, 94.888, 95.169, 95.319]

# # 绘制曲线
plt.plot(x, y, color='#1F4C7B', label='1st device combination',linewidth=3)  # 绘制sin(x)并添加图例
# plt.scatter(x, y, s=30, color='#FFC107', facecolors='none')
plt.fill_between(x, y, 0, color='#CCE4EF', label='Filled area')
...
custom_ticks = [1, 5, 10, 20, 30, 40, 50, 60, 70, 100]  # 自定义的刻度位置
custom_labels = ['1K', '5K', '10K', '20K', '30K', '40K', '50K', '60K', '70K', '100K']  # 自定义的标签
