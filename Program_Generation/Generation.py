...
INSTRUCTION_NAME = ["ADD A, Rn", "ADDC A, Rn", "ANL A, Rn", "DEC Rn", "DJNZ Rn,Start", "INC Rn", "MOV A, Rn",
                    "MOV Rn, #data", "MOV Rn, A", "MOV Rn, #01H", "ORL A, Rn", "SUBB A, Rn", "XCH A, Rn", "XRL A, Rn"]
...
TOTAL_INSTRUCTION = ["ADD A, R1", "ADD A, R2", "ADD A, R3", "ADD A, R4", "ADD A, R5", "ADD A, R6", "ADD A, R7",
                     ...
                     "DEC R7", "DJNZ R0,Start", "DJNZ R1,Start", "DJNZ R2,Start", "DJNZ R3,Start", "DJNZ R4,Start",
                     "DJNZ R5,Start", "DJNZ R6,Start", "DJNZ R7,Start", "INC R0", "INC R1", "INC R2", "INC R3", "INC R4",
                     ...
                     "MOV R0, #01H", "MOV R1, #01H", "MOV R2, #01H", "MOV R3, #01H", "MOV R4, #01H",
                     "MOV R5, #01H", "MOV R6, #01H", "MOV R7, #01H", "ORL A, R0", "ORL A, R1", "ORL A, R2",
...
INSTRUCTION_LEN = np.ones(111)
INSTRUCTION_LEN[31:39] = 2
INSTRUCTION_LEN[71:79] = 2
print(INSTRUCTION_LEN.shape)
...
with open("output.txt", "w") as file:
    ...
    for i in range(200):
        # 前一个随机指令
        rand_num1 = random.randint(0, 110)
        ...
        # 后一个随机指令
        rand_num2 = random.randint(0, 110)
